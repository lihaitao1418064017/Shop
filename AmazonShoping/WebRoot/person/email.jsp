...
<script type="text/javascript" src="../js1/updateEmail.js"></script>
			...
			<div class="main-wrap">
				...
				<div class="m-progress">
					<div class="m-progress-list">
						...
						</span> <span id="over" class="step-2 step"> <em class="u-progress-stage-bg"></em>
				...
				<form class="am-form am-form-horizontal">
					...
					<div class="am-form-group code">
						...
						<div class="am-form-content">
							<input type="tel" id="user-code" placeholder="验证码"><span id="codeC1">***验证码错误***</span>
						</div>
							<style>
					...
					#codeC1{
						...
						<a class="btn" href="javascript:void(0);"
							...
							<div class="am-btn am-btn-danger" id="code1">验证码</div>
						</a>
					</div>
					<div class="info-btn">
