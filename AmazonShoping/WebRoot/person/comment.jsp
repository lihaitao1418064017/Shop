...
<%@page import="com.shop.service.CommentService"%>
...
<script type="text/javascript" src="../js1/comment.js"></script>
								...
								<div class="comment-main">
									...
									<div class="comment-list">
										<%
											...
											List<Comment> cList = CommentService.getAllCommentInfo(svalue);
											...
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint"> <img
														src="<%=ItemService.forIdGetItemInfo(
						cList.get(i).getItem().getId()).getPhoto()%>"
														class="itempic">
													</a>
												</div>
											</li>
											...
											<li class="td td-comment">
												<div class="item-title">
													...
													<div class="item-name">
														<a href="#">
															<p class="item-basic-info"><%=ItemService.forIdGetItemInfo(
						cList.get(i).getItem().getId()).getName()%></p>
														</a>
													</div>
												</div>
												...
												<div class="item-info">
													<div>
														<p class="info-little">
															<span><%=ItemService.forIdGetItemInfo(
						cList.get(i).getItem().getId()).getDescriptive()%></span> <span>包装：<%=ItemService.forIdGetItemInfo(
						cList.get(i).getItem().getId()).getPack()%></span>
														</p>
														<p class="info-time"><%=cList.get(i).getItem().getTime()%></p>
