...
<script type="text/javascript" src="../js1/address.js"></script>
<script type="text/javascript" src="../js1/userInfo.js"></script>
				...
				<div class="am-container header">
					<ul class="message-l">
						<div class="topMessage">
							<div class="menu-hd">
								<a href="../home/login.jsp" target="_top" class="h">亲，请登录</a> <a
									href="../home/register.jsp" target="_top">免费注册</a>
							</div>
						</div>
					</ul>
					<ul class="message-r">
		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-address">
					...
					<hr />
					<ul id="ul" class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
								...
								<form class="am-form am-form-horizontal">
									...
									<div class="am-form-group">
										...
										<div class="am-form-content address">
											<select id="p" data-am-selected>
												<option value="a">北京市</option>
												<option value="a" >上海市</option>
												<option value="a">浙江省</option>
												<option value="a" >湖北省</option>
												<option value="a" selected>陕西省</option>
												<!-- <option value="a" >湖南省</option>
												<option value="a">东北省</option>
												<option value="a" >江苏省</option>
												<option value="a">广东省省</option>
												<option value="a" >河南省</option>
												<option value="a">甘肃省</option>
												<option value="a" >新疆省</option>
												<option value="a">海南省</option> -->
											<!-- 	<option value="sdf">河北省</option> -->
											</select> <select id="c" data-am-selected>
												<option value="a">宝鸡市</option>
												<option value="b">西安市</option>
												<option value="b">渭南市</option>
												<option value="b">汉中市</option>
												<option value="b">延安市</option>
												<option value="b">铜川市</option>
												<option value="b">安康市</option>
												<option value="b">榆林市</option>
												<option value="b">商洛市</option>
											</select> <select id="a" data-am-selected>
												<option value="a">瑞安区</option>
												<option value="b" selected>汉台区</option>
												<option value="b" selected>渭滨区</option>
												<option value="b" selected>陈仓区</option>
												<option value="b" selected>岐山</option>
												<option value="b" selected>扶风</option>
												<option value="b" selected>凤翔</option>
												<option value="b" selected>虢镇</option>
											</select>
										</div>
									</div>
									...
									<div class="am-form-group">
										<div class="am-u-sm-9 am-u-sm-push-3">
											<a class="am-btn am-btn-danger"><span id="save">保存</span></a> <a
												href="javascript: void(0)"
												class="am-close am-btn am-btn-danger" data-am-modal-close><span id="cancel">取消</span></a>
										</div>
									</div>
								</form>
							</div>
