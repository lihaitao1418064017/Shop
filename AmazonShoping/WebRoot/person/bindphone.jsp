...
<script type="text/javascript" src="../js1/bindphone.js"></script>
				...
				<div class="main-wrap">
					...
					<div class="m-progress">
						<div class="m-progress-list">
							<span id="start" class="step-1 step">
                                <em class="u-progress-stage-bg"></em>
                                <i class="u-stage-icon-inner">1<em class="bg"></em></i>
                                <p class="stage-name">绑定手机</p>
                            </span>
							<span id="over" class="step-2 step">
                                <em class="u-progress-stage-bg"></em>
					...
					<form class="am-form am-form-horizontal">
						...
						<div class="am-form-group code">
							...
							<div class="am-form-content">
								<input type="tel" id="user-code" placeholder="短信验证码"><span id="codeC1">***验证码错误***</span>
							</div>
							<style>
					...
					#codeC2{
						...
						font-size:6px;
							...
							<a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
								<div class="am-btn am-btn-danger" id="code1">验证码1</div>
							</a>
						</div>
						...
						<div class="am-form-group code">
							...
							<div class="am-form-content">
								<input type="tel" id="user-new-code" placeholder="短信验证码"><span id="codeC2">***验证码错误***</span>
							</div>
							<a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
								<div class="am-btn am-btn-danger" id="code2">验证码2</div>
							</a>
						</div>
						<div class="info-btn">
