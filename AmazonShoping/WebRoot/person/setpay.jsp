...
<script type="text/javascript" src="../js1/setpay.js"></script>
			...
			<div class="main-wrap">
				...
				<div class="m-progress">
					<div class="m-progress-list">
						<span id="start" class="step-1 step"> <em class="u-progress-stage-bg"></em>
							<i class="u-stage-icon-inner">1<em class="bg"></em></i>
							<p class="stage-name">设置支付密码</p>
							
						</span>
						 <span id="over" class="step-2 step"> <em class="u-progress-stage-bg"></em>
				...
				<form class="am-form am-form-horizontal">
					...
					<div class="am-form-group code">
						...
						<div class="am-form-content">
							<input type="tel" id="user-code" placeholder="短信验证码"><span class="tishi">sdfs</span>
						</div>
						<style>
						.tishi{
						color:red;
						...
						<a class="btn" href="javascript:void(0);"
							...
							<div class="am-btn am-btn-danger" id="mobileCode">验证码</div>
						</a>
					</div>
					...
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-confirm-password"
								placeholder="请再次输入上面的密码"><span class="config">***输入的密码不一致***</span>
						</div>
					</div>
					<div class="info-btn">
