...
<meta name="viewport"
	...
	<script type="text/javascript" src="../js1/pay.js"></script>
</head>
		...
		<div class="paycont">
			...
			<div class="concent">
				...
				<%
					...
					session2.setAttribute("name", svalue);

					List<Product> list;
					list = ItemService.getItemInfo(svalue);
					...
					<div id="J_Bundle_s_1911116345_1_0" class="bundle  bundle-last">
						<div class="bundle-main">
							<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="#" class="J_MakePoint"> <img
												...
												src="<%=list.get(i).getPhoto()%>" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
												<a href="#" target="_blank" title="美康粉黛醉美唇膏 持久保湿滋润防水不掉色"
													class="item-title J_MakePoint" data-point="tbcart.8.11"><%=list.get(i).getName()%></a>
											</div>
										</div>
									</li>
									<li class="td td-info">
										<div class="item-props">
											<span class="sku-line"><%=list.get(i).getDescriptive()%></span>
											<span class="sku-line"><%=list.get(i).getPack()%></span>
										</div>
									</li>
									<li class="td td-price">
										<div class="item-price price-promo-promo">
											<div class="price-content">
												<em class="J_Price price-now" id="danjia"><%=list.get(i).getPrice()%></em>
											</div>
										</div>
									</li>
								</div>
								...
								<li class="td td-amount">
									<div class="amount-wrapper ">
										<div class="item-amount ">
											...
											<div class="sl">
												<input id="jian" class="min am-btn" name="" type="button"
													value="-" /> <input id="sum" class="text_box" name=""
													type="text" value="3" style="width:30px;" /> <input
													id="jia" class="add am-btn" name="" type="button" value="+" />
											</div>
										</div>
									</div>
								</li>
								<li class="td td-sum">
									<div class="td-inner">
										<em tabindex="0" class="J_ItemSum number" id="zongjia">117.00</em>
									</div>
								</li>
								<li class="td td-oplist">
									<div class="td-inner">
										<span class="phone-title">配送方式</span>
										<div class="pay-logis"></div>
									</div>
								</li>
			...
			<div class="buy-point-discharge ">
				<p class="price g_price ">
					合计（含运费） <span>¥</span><em class="pay-sum" id="zong"></em>
				</p>
			</div>
					...
					<div class="box">
						<div tabindex="0" id="holyshit267" class="realPay">
							<em class="t">实付款：</em> <span class="price g_price "> <span>¥</span>
								<em class="style-large-bold-red "></em><span id="zongq">
							</span>
							</span>
						</div>
						...
						<div id="holyshit268" class="pay-address">
							...
							<p class="buy-footer-address">
								...
								</span> <span class="buy-phone"></span>
								</span>
							</p>
						</div>
					</div>
