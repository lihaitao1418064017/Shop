...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="../js1/introduction.js"></script>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a id="bigphoto1a" href="../images/01.jpg"><img id="bigPhoto1" src="../images/01_mid.jpg" alt="细节展示放大镜特效" rel="../images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<img id="small" src="../images/01_small.jpg" mid="../images/01_mid.jpg" big="../images/01.jpg">
									</div>
								</li>
								<!-- <li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count" id="month">1015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count" id="total">6015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
									<div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count" id="pinjia">640</span></div>
								</li>
							</ul>
							<div class="clear"></div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li id="kouwei" class="sku-line selected">原味<i></i></li>
													...
													<div class="theme-options">
														...
														<ul>
															<li id="baozhuang" class="sku-line selected">手袋单人份<i></i></li>
							...
							<div class="shopPromotion gold">
								<div class="hot">
									...
									<div class="gold-list">
										<p id="per">购物满2件打8折，满3件7折<span>点击领券<i class="am-icon-sort-down"></i></span></p>
									</div>
								</div>
								<div class="clear"></div>
								<div class="coupon">
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li class="type" title="">产品类型:&nbsp;烘炒类</li>
											<li class="des" title="">原料产地:&nbsp;巴基斯坦</li>
											<li class="eat" title="">产地:&nbsp;湖北省武汉市</li>
											<li class="pack" title="">配料表:&nbsp;进口松子、食用盐</li>
											<li class="per" title="">产品规格:&nbsp;210g</li>
											<li class="shopTime" title="">保质期:&nbsp;180天</li>
											<li class="taste" title="">产品标准号:&nbsp;GB/T 22165</li>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img class="tuijian" src="" />
													<p id="ms">【良品铺子_开口松子】零食坚果特产炒货
