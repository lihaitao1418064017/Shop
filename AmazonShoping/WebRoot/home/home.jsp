		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						<a href="login.jsp" target="_top" id="h" class="h">亲，请登录</a> <a
							href="register.jsp" target="_top" class="r">免费注册</a>
					</div>
				</div>
			</ul>
			<ul class="message-r">
				...
				<div class="topMessage my-shangcheng">
					<div class="menu-hd MyShangcheng">
						<a href="../person/index.jsp" target="_top" class="person"><i
	...
	<div class="shopMainbg">
		<div class="shopMain" id="shopmain">
			...
			<div id="f1">
				...
				<div class="am-g am-g-fixed floodFour">
					...
					<div class="am-u-sm-7 am-u-md-4 text-two sug">
						...
						<img id="t2" src="<%=list.get(1).getPhoto()%>" />
					</div>
					...
					<div class="am-u-sm-7 am-u-md-4 text-two">
						...
						<img id="t3" src="<%=list.get(2).getPhoto()%>" />
					</div>
					...
					<div class="am-u-sm-3 am-u-md-2 text-three big">
						...
						<img id="t4" src="<%=list.get(3).getPhoto()%>" />
					</div>
					...
					<div class="am-u-sm-3 am-u-md-2 text-three sug">
						...
						<img id="t5" src="<%=list.get(4).getPhoto()%>" />
					</div>
					...
					<div class="am-u-sm-3 am-u-md-2 text-three ">
						...
						<img id="t6" src="<%=list.get(5).getPhoto()%>" />
					</div>
					...
					<div class="am-u-sm-3 am-u-md-2 text-three last big ">
						...
						<img id="t1" src="<%=list.get(0).getPhoto()%>" />
					</div>
			...
			<div class="footer ">
				...
				<div class="footer-bd ">
					<p>
						<a href="# "></a> <a href="# "></a> <a href="# ">联系我们</a> <a
							href="# "></a> <em>© <a href="http://www.cssmoban.com/"
